...
import 'package:kimoa/pages/q_four.dart';

class QThree extends StatefulWidget {
  const QThree({Key? key}) : super(key: key);

  @override
  _QThreeState createState() => _QThreeState();
}

class _QThreeState extends State<QThree> with SingleTickerProviderStateMixin {
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      if (controller.spouseHeight.value != '') {
                        if (controller.spouseHeight.value[
                                controller.spouseHeight.value.length - 1] ==
                            '.') {
                          controller.spouseHeight.value =
                              controller.spouseHeight.value + '0';
                        }
                        print(controller.spouseHeight.value);
                        Get.to(const QFour());
                      }
                    },
                    child: Obx(() => AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                              ...
                              color: controller.spouseHeight.value != ''
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          onTapDown: (val) {
                            ...
                            if (controller.spouseHeight.value.length < 5) {
                              controller.spouseHeight.value =
                                  controller.spouseHeight.value + '7';
                            }
                          },
                          onTapUp: (val) {
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          onTapDown: (val) {
                            ...
                            if (controller.spouseHeight.value.length < 5) {
                              controller.spouseHeight.value =
                                  controller.spouseHeight.value + '8';
                            }
                          },
                          onTapUp: (val) {
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          onTapDown: (val) {
                            ...
                            if (controller.spouseHeight.value.length < 5) {
                              controller.spouseHeight.value =
                                  controller.spouseHeight.value + '9';
                            }
                          },
                          onTapUp: (val) {
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          onTapDown: (val) {
                            ...
                            if (controller.spouseHeight.value.length < 5) {
                              controller.spouseHeight.value =
                                  controller.spouseHeight.value + '4';
                            }
                          },
                          onTapUp: (val) {
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          onTapDown: (val) {
                            ...
                            if (controller.spouseHeight.value.length < 5) {
                              controller.spouseHeight.value =
                                  controller.spouseHeight.value + '5';
                            }
                          },
                          onTapUp: (val) {
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          onTapDown: (val) {
                            ...
                            if (controller.spouseHeight.value.length < 5) {
                              controller.spouseHeight.value =
                                  controller.spouseHeight.value + '6';
                            }
                          },
                          onTapUp: (val) {
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          onTapDown: (val) {
                            ...
                            if (controller.spouseHeight.value.length < 5) {
                              controller.spouseHeight.value =
                                  controller.spouseHeight.value + '1';
                            }
                          },
                          onTapUp: (val) {
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          onTapDown: (val) {
                            ...
                            if (controller.spouseHeight.value.length < 5) {
                              controller.spouseHeight.value =
                                  controller.spouseHeight.value + '2';
                            }
                          },
                          onTapUp: (val) {
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          onTapDown: (val) {
                            ...
                            if (controller.spouseHeight.value.length < 5) {
                              controller.spouseHeight.value =
                                  controller.spouseHeight.value + '3';
                            }
                          },
                          onTapUp: (val) {
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          onTapDown: (val) {
                            ...
                            if (controller.spouseHeight.value.contains('.')) {
                              return;
                            }
                            if (controller.spouseHeight.value.length < 5) {
                              controller.spouseHeight.value =
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          onTapDown: (val) {
                            ...
                            aniController.forward();
                            int a = controller.spouseHeight.value.length;
                            controller.spouseHeight.value = controller
                                .spouseHeight.value
                                .substring(0, a - 1);
                          },
                          onTapUp: (val) {
